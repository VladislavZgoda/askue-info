    ...
    it('can view the meter', function () {
        ...
        $response->assertOk()
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->has('meter')
                ->whereType('meter', 'array')
                ->has('meter.id')
                ->has('meter.model')
                ->has('meter.serial_number')
                ...
                ->has(
                    'meter.simCards', $meter->simCards_count, fn (Assert $simCard) => $simCard
                        ->has('id')
                        ->has('number')
                        ->has('operator')
                        ->etc()
                ...
                ->has('meter.installationObject')
                ->whereType('meter.installationObject', 'array')
                ->has('meter.installationObject.id')
                ->has('meter.installationObject.name')
                ->has('meter.installationObject.address')
                ->whereType('meter.installationObject.id', 'integer')
                ->whereType('meter.installationObject.name', 'string')
                ->whereType('meter.installationObject.address', 'string')
            );
    });
});
